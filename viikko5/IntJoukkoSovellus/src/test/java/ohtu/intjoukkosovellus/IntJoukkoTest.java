...
public class IntJoukkoTest {
    ...
    public void vainLisatytLuvutLoytyvat() {
        assertTrue(joukko.LoytyykoTaulukosta(10));
        assertFalse(joukko.LoytyykoTaulukosta(5));
        assertTrue(joukko.LoytyykoTaulukosta(3));
    }

    @Test
    public void poistettuEiOleEnaaJoukossa() {
        joukko.poistaTaulukosta(3);
        assertFalse(joukko.LoytyykoTaulukosta(3));
    ...
    public void toimiiKasvatuksenJalkeen(){
        ...
        assertTrue(joukko.LoytyykoTaulukosta(11));
        joukko.poistaTaulukosta(11);
        assertFalse(joukko.LoytyykoTaulukosta(11));
